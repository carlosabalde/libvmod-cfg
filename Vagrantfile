...
$script = <<SCRIPT
  ...
  apt-get install -qq unzip apt-transport-https \
    ...
    lua5.1 liblua5.1-0-dev luajit libluajit-5.1-dev vim-common python-is-python3

  # Varnish Cache.
  sudo -u vagrant bash -c '\
    wget --no-check-certificate https://varnish-cache.org/_downloads/varnish-4.1.11.tgz; \
