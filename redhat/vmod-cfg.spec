...
Requires: varnish >= 7.2.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 7.2.0, varnish-devel >= 7.2.0, libcurl-devel, luajit-devel, jemalloc-devel, vim-common
