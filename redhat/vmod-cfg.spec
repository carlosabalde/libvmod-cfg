...
Requires: varnish >= 9.1.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 9.1.0, varnish-devel >= 9.1.0, libcurl-devel, luajit-devel, jemalloc-devel, vim-common
