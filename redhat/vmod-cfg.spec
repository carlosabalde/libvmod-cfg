...
Requires: varnish >= 6.2.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 6.2.0, varnish-devel >= 6.2.0, libcurl-devel, luajit-devel, jemalloc-devel, vim-common
