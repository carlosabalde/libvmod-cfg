...
Requires: varnish >= 7.7.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 7.7.0, varnish-devel >= 7.7.0, libcurl-devel, luajit-devel, jemalloc-devel, vim-common
