...
Requires: varnish >= 7.5.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 7.5.0, varnish-devel >= 7.5.0, libcurl-devel, luajit-devel, jemalloc-devel, vim-common
