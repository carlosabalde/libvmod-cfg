...
Requires: varnish >= 6.1.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 6.1.0, varnish-devel >= 6.1.0, libcurl-devel, luajit-devel, jemalloc-devel
...
%changelog
* Mon May 27 2019 Carlos Abalde <carlos.abalde@gmail.com> - 6.5-1.20190527
- Fixed error in check_remote() when backup file can't be opened.
* Wed May 15 2019 Carlos Abalde <carlos.abalde@gmail.com> - 6.4-1.20190515
