...
Requires: varnish >= 6.0.0, libcurl, luajit, jemalloc
BuildRequires: make, python-docutils, varnish >= 6.0.0, varnish-devel >= 6.0.0, libcurl-devel, luajit-devel, jemalloc-devel
