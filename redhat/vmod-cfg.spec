...
Requires: varnish >= 6.5.0, libcurl, luajit
BuildRequires: make, python-docutils, varnish >= 6.5.0, varnish-devel >= 6.5.0, libcurl-devel, luajit-devel, jemalloc-devel, vim-common
